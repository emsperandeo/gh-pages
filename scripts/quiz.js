...
for(i=0; i<scoring.length; i++) {
  ...
  scoring = [
             ...
             {score:"Animals:",feedback:"Surpisingly enough, all four of these options are affected by your dietary choices. Your physical health will take a big hit with excessive meat and starch intake, greenhouse gases are increasing more rabidly than ever (www.psmag.com/environment/gluttony-global-warming-eating-warmer-planet-96495), water shortages are predicted as early as 2050 (https://)www.forksoverknives.com/freshwater-abuse-and-loss-where-is-it-all-going/), and your compassion for animals is sacrificed at the price of a burger. Animals are tortured, abused, and then murdered. There is no such thing as humane dairy or meat production (www.freefromharm.org/dairyfacts/). It's time to stop ignoring the fact that the food we eat is contributing to global warming, mass murder, and illness. These are choices we make, and by making such a simple decision to change what we put in our bodies, we can save the lives of animals and our future generations. Let's keep the earch habitable.", image: "images/pigs.jpg"},
             ];
